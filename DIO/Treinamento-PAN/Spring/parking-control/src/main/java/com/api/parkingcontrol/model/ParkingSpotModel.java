...
public class ParkingSpotModel implements Serializable {
	...
	private static final long serialVersionUID = 1L; //esse id é do Serializable
	...
	private String licencePlateCar; //placa do carro
	...
	public ParkingSpotModel(String parkingSpotNumber, String licencePlateCar, String brandCar, String modelCar,
	...
	public String toString() {
		return "ParkingSpotModel [id=" + id + ", parkingSpotNumber=" + parkingSpotNumber + ", licencePlateCar="
				+ licencePlateCar + ", brandCar=" + brandCar + ", modelCar=" + modelCar + ", colorCar=" + colorCar
